        ...
        <el-card class="box-card">
          ...
          <el-form :model="ruleForm2" status-icon :rules="rules2" ref="ruleForm2" class="demo-ruleForm">
            ...
            <el-form-item prop="fullName">
              ...
              <el-input v-model.number="ruleForm2.fullName" placeholder="Введіть повне ім'я"></el-input>
            </el-form-item>

            <el-form-item prop="email">
              <label>Номер електронної пошти *</label>
...
export default {
  ...
  data() {
    var checkFullName = (rule, value, callback) => {
      if (!value) {
        return callback(new Error("Будь ласка, введіть повне ім'я"));
      } else {
        callback();
      }
    };
