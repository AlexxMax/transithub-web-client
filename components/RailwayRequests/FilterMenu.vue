  ...
  >
    <el-form ref="form" label-width="120px" label-position="top" size="mini" @submit.native.prevent>
      ...
      <el-form-item v-loading="loadingStatuses" :label="$t('forms.common.status')">
        <el-checkbox-group v-model="filterStatuses" class="RailwayRequestsStatuses">
          <el-checkbox
...
export default {
  ...
  computed: {
    ...
    filterGoods: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.goods
        );
      },
      set(value) {
    ...
    filterRailwayAffilations: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.railwayAffilations
        );
      },
      set(value) {
        this.setFilter(
    ...
    filterRailwayStationsFrom: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.railwayStationsFrom
        );
      },
      async set(value) {
        this.setFilter(
    ...
    filterRailwayStationsRoadsFrom: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.railwayStationsRoadsFrom
        );
      },
      set(value) {
        this.setFilter(
    ...
    filterRailwayReferenceStations: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.railwayReferenceStations
        )[0];
      },
      set(value) {
        this.setFilter(
    ...
    filterPolygonNumbers: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.polygonNumbers
        );
      },
      set(value) {
        this.setFilter(
    ...
    filterRailwayStationsTo: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.railwayStationsTo
        );
      },
      async set(value) {
        this.setFilter(
    ...
    filterCompanies: {
      get() {
        return getFilterValue(
          this.$store.state.railwayRequests.filters.set.companies
        );
      },
      set(value) {
        this.setFilter(
    ...
    select() {
      const select = {
        ...
        companies: this.$store.state.railwayRequests.filters.data.companies
          .items,
  ...
  methods: {
    ...
    async saveFilters() {
      ...
      this.$store.dispatch(
        "railwayRequests/createNewSavedFilters",
    ...
    handleOpenFiltersMenu() {
      ...
      const loadCachedStations = async (
        ...
        const rwCodes =
          this.$store.state.railwayRequests.filters.set[filterKey] || [];
        if (rwCodes.length > 0) {
