<template>
  <div>
    ...
    <RailwayRequestEditForm
      ...
      :parent-station-to-r-w-code="aggregationStationToRWCode"
      :parent-station-to-name="aggregationStationToName"
...
export default {
  ...
  props: {
    ...
    aggregationStationToRWCode: [ Number, String ],
    aggregationStationToName: String,
    demo: Boolean
  },
