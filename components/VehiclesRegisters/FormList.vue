  ...
  methods: {
    ...
    generateListItemData(vr) {
      const period = {
        ...
        widthMd: 2,
        title: this.$t('lists.period') + ': ',
        value: `${vr.periodFrom} ${vr.periodTo}`
      }
      ...
      return [ period, driver, phone, vehicle, trailer, trips, pointFrom, pointTo, status, more ]
    },
