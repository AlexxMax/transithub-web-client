...
export default {
  ...
  computed: {
    ...
    currentRailwayAggregationGuid: {
      get() {
        return this.$store.state.railwayAggregationsMap.mapData.railwayAggregationGuidToOpen
      },
      set(value) {
        this.$store.commit('railwayAggregationsMap/SET_RAILWAY_AGGREGATION_ID_TO_OPEN', value)
      }
    }
  },
