...
import * as parkingQueueProfilesParkings from '@/utils/api/pq.queueProfiles.parkings.api'
...
export default (context) => {
  return {
    ...
    parkingQueueProfilesParkings: mapBindMethods(context, parkingQueueProfilesParkings)
  }
}
